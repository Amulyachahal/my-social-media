...
const Profile = () => {
  ...
  const userData = userState.users.filter((user) => user.username === username);
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <div>editable user description</div> */}
        <div>
          <a
            target="_blank"
        ...
        <div>
          <a href="https://github.com/Amulyachahal" target="_blank">
            GitHub
          </a>
        </div>
        {/* <div>
          <div>{userData.user.following.length} Following</div>
          <div>{userData.user.followers.length} Followers</div>
        </div> */}
